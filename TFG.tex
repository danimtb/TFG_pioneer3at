...
%genera índice
\cleardoublepage
\pdfbookmark{\contentsname}{Índice general}
\tableofcontents

%índice de figuras.
\cleardoublepage
\pdfbookmark{\contentsname}{Índice de figuras}
\listoffigures

%índice de tablas.
\cleardoublepage
\pdfbookmark{\contentsname}{Índice de tablas}
\listoftables

\cleardoublepage
\pdfbookmark{\contentsname}{Índice de códigos}
\listofcodes
