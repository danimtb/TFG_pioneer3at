...
La primera configuración del robot consistió en ambos sensores situados en la parte frontal del mismo. Ambos sensores de encontraba uno encima del otro, de tal forma que no existieran interferencias entre uno y otro.

**Imagen del robot**

\subsubsection{Config1}
...
El primero de ellos fueron las direcciones IP en el ordenador interno del Pioneer. Debido a que el sensor láser se conecta vía Ethernet a este ordenador, el nodo LMS1xx debe obtener información a través de la IP del láser y enviarla a través del adaptador Wifi a la IP del nodo máster. El problema residía en que el nodo se saturaba al tener que lidiar con ambas interfaces de conexión y provocaba su detención.
...
Sin embargo en ocasiones la recepción y envío de datos era demasiado alta y esto provocaba que existiese demasiado retraso en la comunicación, provocando que el robot reaccionase tarde para esquivar los obstáculos y el control del robot fuera impracticable.
