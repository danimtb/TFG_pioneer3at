...
global_costmap:
  ...
  inflation_layer:
    ...
    cost_scaling_factor: 4.0
\end{lstlisting}
\caption[Configuración de \textit{global\_costmap} para navegación reactiva]{Configuración de \textit{global\_costmap} para navegación reactiva\footnotemark.}
\end{code}
\footnotetext{Fuente: \href{https://github.com/danimtb/pioneer3at_ETSIDI/blob/master/pioneer_utils/navigation/local_navigation/global_costmap_params.yaml}{\textit{pioneer\_utils/navigation/local\_navigation/global\_costmap\_params.yaml}}}
...
\end{lstlisting}
\caption{Fragmento de código del nodo \textit{nav-waypoints}}{Fragmento de código del nodo \textit{nav-waypoints}\footnotemark.}
\end{code}
\footnotetext{Fuente: \href{https://github.com/danimtb/pioneer3at_ETSIDI/blob/master/navigation_goals/src/nav-waypoints.cpp}{\textit{navigation\_goals/src/nav-waypoints.cpp}}}
...
\end{lstlisting}
\caption[Archivo \textit{launchfile} para el nodo \textit{endurance\_test}.]{Archivo \textit{launchfile} para el nodo \textit{endurance\_test}\footnotemark.}
\end{code}
\footnotetext{Fuente: \href{https://github.com/danimtb/pioneer3at_ETSIDI/blob/master/pioneer_utils/main/endurance_test_lab.launch}{\textit{pioneer\_utils/main/endurance\_test\_lab.launch}}}
...
\end{lstlisting}
\caption{Fragmento del nodo \textit{voice\_cmd\_vel} utilizando el cliente de sonido de \textit{soundplay\_node}.}
\end{code}
...
...
\end{lstlisting}
\caption{Fragmento del nodo \textit{voide\_cmd\_vel} utilizando las palabras reconocidas por el nodo \textit{recognizer}.}
\end{code}
...
\end{lstlisting}
\caption[Archivo \textit{voice\_cmd.launch}]{Archivo \textit{voice\_cmd.launch}\footnotemark.}
\end{code}
\footnotetext{
...
El código fuente de este nodo se ha omitido por no alargar la explicación, sin embargo puede consultarse de forma externa\footnote{Fuente: \href{https://github.com/danimtb/pioneer3at_ETSIDI/blob/master/pioneer_utils/voice_audio/node/voice_cmd_vel.py}{\textit{pioneer\_utils/voice\_audio/node/voice\_cmd\_vel.py}}}.