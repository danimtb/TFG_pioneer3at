...
En este caso la configuración del mapa global carece una capa estática, por lo que el mapa se desplaza junto con el robot.
y se confía en la odometría del robot para realizar la orientación.
