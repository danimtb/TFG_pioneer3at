...
\begin{figure}[!htp]
\centering
\includegraphics[width=0.65\textwidth]{figuras/primera_configuracion1.jpg}
...
Las pruebas realizadas utilizando ofrecieron un resultado correcto, ya que el procesado de la nube de puntos es más rápido y permite realizar los cáculos a una frecuencia adecuada. Sin embargo esta estrategia requiere más de una instancia de estos nodos para poder detectar obstáculos bajos a corta (hasta 1.5 metros) y media distancia (hasta unos 3 metros) para que no se produzcan interferencias con el suelo.
...
\end{lstlisting}
\caption{\textit{Launchfile} del nodo \textit{DepthImage\_to\_LaserScan} para obstáculos bajos.}\footnotemark
\end{code}
\footnotetext{\hypersetup{urlcolor=black}
Fuente: \href{https://github.com/danimtb/pioneer3at_ETSIDI/blob/master/pioneer_utils/sensors/kinect_to_laser_low.launch}{\textit{pioneer\_utils/sensors/kinect\_to\_laser\_low.launch}}
...
\begin{figure}[htp]
\centering
\includegraphics[width=0.42\textwidth]{figuras/global_costmap_inflation.png}
