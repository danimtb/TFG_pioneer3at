...
De este modo, se crearon 3 instancias diferentes de este nodo: uno para obstáculos situados a una distancia mayor, un segundo para obstáculos a distancias medias, y un tercero para obstáculos a distancias cortas\footnote{hola}.
...
\end{lstlisting}
\caption{Launchfile \textit{DepthImage\_to\_LaserScan} para obstáculos lejanos.}\footnote{adios}
\end{code}
...
\caption{Launchfile \textit{DepthImage\_to\_LaserScan} para obstáculos lejanos.}
\end{code}
