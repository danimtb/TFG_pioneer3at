...
export ROS_MASTER_URI=http://10.42.0.1:11311
\end{lstlisting}
\caption{Ejemplo \textit{.bashrc} en un ordenador externo para realizar comunicación con el nodo MASTER.}
\end{code}
...
...
\end{lstlisting}
\caption[Fragmento de código del nodo \textit{teleop\_p3at}.]{Fragmento de código del nodo \textit{teleop\_p3at}\footnotemark.}
...
\end{lstlisting}
\caption[Fragmento de código del nodo \textit{moving\_alone}.]{Fragmento de código del nodo \textit{moving\_alone}\footnotemark.}
