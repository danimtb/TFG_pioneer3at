...
\Huge \textsc{Guiado de un robot móvil basado en ROS y kinect}\\[1 cm]
...
\emph{Cotutor:} Dr. Miguel Hernando Gutiérrez\\
\emph{Departamento:} Electricidad, Electrónica, Automática y Física aplicada.
\end{flushleft}

\begin{flushleft} \Large
\emph{Tutor:} Dr. Alberto Brunete González\\
\emph{Departamento:} Electricidad, Electrónica, Automática y Física aplicada.
\end{flushleft}
