...
\item Control del movimiento del robot Pioneer 3 AT a través de ROS, así como la obtención de la información de la odometría, estado de la batería, encendido de motores, etc.
\setcounter{enum3}{\value{enumi}}
\end{enumerate}
...
\item En el capítulo 4 se habla de los conceptos relacionados con ROS, su filosofía de funcionamiento y sus herramientas así como la estructura del desarrollo software llevado a cabo en este proyecto.
...
Adicionalmente existen 3 apéndices que sirven de apoyo a las explicaciones del proyecto, donde se realizan explicaciones adicionales y un manual aclaratorio del funcionamiento del sistema robótico objeto de este proyecto.