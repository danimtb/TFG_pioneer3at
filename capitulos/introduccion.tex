...
Este proyecto surge como una manera de actualizar y poner en funcionamiento el robot móvil de investigación Pioneer 3 AT, actualizarlo a una nueva plataforma robótica como es ROS e implementar la navegación autónoma del robot basada en sensores de percepción del entorno como el sensor Kinect y un sensor láser tipo LIDAR.
