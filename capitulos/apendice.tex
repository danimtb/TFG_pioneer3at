...
\item LED MOTORS: Indica el estado de los motores.
...
\item SERIAL: Puerto RS-232 que comunica con la placa de control. Puede ser utilizado para conectar un ordeandor externo directamente la la placa de control del robot.
\end{itemize}
