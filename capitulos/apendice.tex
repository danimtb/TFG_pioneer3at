...
Sin embargo, es recomendable que si se desea realizar algún desarrollo posterior, se realice un fork en GitHub de este proyecto (Figura \ref{fig:pioneer3at_ETDSIDI}) y se clone el repositorio propio.
...
Es posible que necesitemos las dependencias añadida de \textit{audio\_capture}.
...
El sensor Kinect utilizado en el proyecto no dispone de ninguna moficiación específica o modo de funcionamiento especial. Lo referente a su conexionado ha sido descrito anteriormente en la sección \ref{subsection:implementacion_kinect}.
