...
El robot debe ser capaz de localiarse y situarse en el entorno, el sensor kinect ofrecerá información sobre los objetos alrededor del robot y el software desarrollado para ROS deberá ser capaz de hacer un control reactivo sobre los movimientos del robot para guiarlo hacia un punto indicado.\\
