...
Estos robots, preparados para aguantar la raciación y realizar tareas de exploración y limpieza son Quincedesarrolado por Chiba Institute of Technology **referencia**,, un robot móvil capaz de subir y bajar escaleras y operar en las plantas superiores de la central nuclear.

\begin{figure}[htp]
\centering
\includegraphics[width=0.4\textwidth]{figuras/quince_robot.jpg}
\caption{Robots de desactivación de explosivos: iRobot 510 Packbot y TALON} \label{fig:quince_robot}
\end{figure}


Y Raccoon, desarrollado por Tepco, equipado con dos cabezales móviles preparados para aspirar y limpiar, encargado de recuperar el polvo contaminado del edificio del reactor 2.
: DESASTRE NUCLEAR JAPON.\\

Limpieza y logística: Roomba y robots Amazon.\\
