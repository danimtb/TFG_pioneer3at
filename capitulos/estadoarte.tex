...
La investigación en inteligencia artificial desarrolló formas de procesamiento de información más parecido al razonamiento humano, las primeras patentes aparecieron en 1946 con los muy primitivos robots para traslado de maquinaria y las primeras computadoras.

En 1960 se introdujo el primer robot "Unimate'', basado en la transferencia de artículos. Este robot se instaló en las Ford Motors Company para atender una máquina de fundición de troquel.

En 1966 Trallfa, una empresa noruega, construyó e instaló un robot de pulverización de pintura y en 1971 la universidad de Stanford desarrolló el ''Standford Arm'', un brazo robótico de accionamiento eléctrico. Más tarde, en 1978 se introdujo el robot PUMA para tareas de montaje por Unimation, basándose en diseños obtenidos en un estudio de la General Motors.

En la actualidad, la robótica se debate entre modelos más ambiciosos, como es el caso del IT, diseñado para expresar emociones, el COG, tambien conocido como el robot de cuatro sentidos, el famoso SOUJOURNER o el LUNAR ROVER, vehículo de turismo con control remotos, y otros mucho mas específicos como el CYPHER, un helicóptero robot de uso militar, el guardia de trafico japonés ANZEN TARO o los robots mascotas de Sony.
...
Otros sensores de distancia en 3 dimensiones, son los sensores de tipo infrarrojo, como es el sensor Kinect, que ha se ha vuelto muy popular debido a su bajo coste y su buena respuesta.
