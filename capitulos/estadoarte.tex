...
También existen los sensores de ultrasonidos, los cuales emiten una señal ultrasónica en forma de pulso para posteriormente recibir el reflejo de la misma al rebotar en un objeto. En robótica móvil es común colocar varios sensores de este tipo alrededor del robot.
