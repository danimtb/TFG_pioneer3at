...
\item textbf{En cuanto a las características del robot:}\\
...
Obstáculos de materiales transparentes no son visibles por ninguno de los dos sensores debido a su naturaleza infrarroja, por tanto se definen este tipo de obstáculos como caso límite para el sistema robótico.
\end{itemize}
