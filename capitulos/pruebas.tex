...
Con la ayuda de Gazebo se han podido pobar todas las configuraciones de navegación, el funcionamiento de cada nodo y el intercambio de datos entre ellos.
