...
\caption{Mapa con la primera prueba de SLAM\footnotemark.}
...
\caption{Mapa tras la segunda prueba de SLAM\footnotemark.}
...
Los puntos de meta preestablecidos se distribuyen en el mapa tal y como se muestra en la figura \ref{Gazebo} y el root navega aleatoriamente de uno a otro.

\begin{figure}[!htp]
\centering
\includegraphics[width=\textwidth]{figuras/mapa_endurance.png}
