...
Como es normal en una navegación reactiva, el robot se desplaza siguiendo la trayectoria más corta en base a la información que sus sensores captan en ese momento, por lo que suceden casos, como en la figura \ref{fig:navegacion_local_gazebo}, en los que la trayectoria global calculada no es la correcta en un principio. A pesar de ello, gracias a la información de los obstáculos que queda retenida en el mapa global, el planificador recalcula encontrando la trayectoria adecuada.
...
\caption{Primera prueba de resistencia real.}
...
Sobre estos resultados cabe decir que el número de metas alcanzadas se ve reducido debido a que en ocasiones el planificador global precisaba de algún reintento para trazar la trayectoria al punto de meta y a que el robot a veces encontraba dificultades para planificar a través de pasos estrechos.
...
\subsection{Aspectos de la navegación}
