...
\begin{figure}[!htp]
\centering
\includegraphics[width=0.8\textwidth]{figuras/discrepancia_costmaps_gazebo.png}
...
\begin{figure}[!htp]
\centering
\includegraphics[width=0.8\textwidth]{figuras/navegacion_global_gazebo.png}
...
\includegraphics[width=0.45\textwidth]{figuras/navegacion_local2_gazebop.png}
\caption{Navegación con mapa final.}
