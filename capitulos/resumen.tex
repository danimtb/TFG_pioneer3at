...
El robot Pioneer 3 AT es el robot móvil que se ha empleado en este proyecto (Figura \ref{fig:esquema_robot1}) y sobre el que se ha trabajado de manera específica para realizar las pruebas reales de este proyecto. A este robot se le incorporan un sensor láser de dos dimensiones (sensor Sick LMS100) y un sensor de tres idmensiones (sensor Kinect). El cómputo de la navegación se realiza en un ordenador compacto incorporado en el robot (ordenador Intel NUC NUC5i7RYH).
...
\paragraph{Palabras clave:} robot móvil, ROS, navegción reactiva, cálculo de trayectorias.
