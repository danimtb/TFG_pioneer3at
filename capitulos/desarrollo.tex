...
El robot Pioneer 3 AT (Figura ), perteneciente a la empresa Adept MobileRobots, es un robot de cuatro ruedas en configuración skid-steer y todo terreno (AT, All Terrain) de operación e investigación en laboratorio.\\

\begin{figure}[htp]
\centering
\includegraphics[width=0.4\textwidth]{figuras/pioneer_3_at.jpg}
\caption{Diagram of the robotic system used for this project} \label{fig:pioneer3at}
\end{figure}
